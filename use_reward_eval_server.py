...
Example usage:
python use_reward_eval_server.py --eval-server-url http://localhost:8004 \ 
...
def main() -> None:
    ...
    parser.add_argument("--eval-server-url", type=str, default="http://localhost:8004", help="Base URL, e.g. http://localhost:8004 or http://10.0.0.4:8004")
    parser.add_argument(
        "--video",
        type=str,
        required=True,
